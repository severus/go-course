...
to \textbf{run faster} because they operate closer to the ``bare metal'', but
...
You can run, save, and share your Go codes on our \textbf{Code Playground}, without
...
\href{https://golang.org/doc/install}{instructions on the Go site} to install all
...
\hypertarget{predeclared-identifiers}{%
\subsubsection{Predeclared identifiers}\label{predeclared-identifiers}}
